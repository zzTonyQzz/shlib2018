<template>
  <div class="vue-waterfall-easy" :class="isMobile?'clearfix':''" :style="isMobile? '':{width:colWidth*columnCount+'px',height:fullHeight+'px',left:'50%',marginLeft: -1*colWidth*columnCount/2 +'px'}">
    <div class="img-box clearfix" v-for="(v,i) in imgsArrC" 
    :style="{padding:gap/2+'px',width: isMobile ? '' : colWidth+'px'}" :key="i">
